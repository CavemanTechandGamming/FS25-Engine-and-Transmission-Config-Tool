...
This is a completely portable version of the FS25 Engine and Transmission Config Tool.
No installation required - just run the EXE file from any location!

This file is part of the "FS25 Engine and Transmission Config Tool Portable Release" package.
